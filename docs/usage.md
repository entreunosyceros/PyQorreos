...
1. Muestra **de inmediato** los mensajes en caché de la **última carpeta** que usaste en esa cuenta y el **árbol de carpetas** guardado.
2. **Se conecta al servidor** y comprueba si hay correo nuevo (mensaje en la barra de estado; indicador **Conectado** / **Sincronizando…** a la derecha).
3. Si hay mensajes nuevos que descargar, aparece la **barra de progreso** bajo la lista; si no hay novedades, no queda activa.
4. Si tienes varias cuentas y la sincronización en segundo plano está activa, actualiza también el INBOX de las demás cuentas.
...
**Ver también:** [Atajos de teclado](keyboard-shortcuts.md) · [Características](features.md) · [Configuración y notas](configuration.md)
